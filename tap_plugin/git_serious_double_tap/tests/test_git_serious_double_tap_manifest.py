"""Plugin validation-system tests: the package-mode identity chain and manifest are sound.

Structure-level (no Django): runs standalone and in the plugin CI conformance leg.
"""
